...
class Program():
    ...
    def main(self):
        ...
        for stream in streams:
            ...
            additionnalInfosURL = "https://www.googleapis.com/youtube/v3/videos?key=" + self.youtubeKey + "&id=" + stream['videoId'] + "&part=snippet,contentDetails,liveStreamingDetails,statistics"
            ...
            try:
                ...
                print(f"[×] idVideo={stream['videoId']} Error additionnalInfosURL {additionnalInfosURL} : {e}")
                self.writelog(f"[×] idVideo={stream['videoId']} Error additionnalInfosURL {additionnalInfosURL} : {e}")
                self.exitProgram()
